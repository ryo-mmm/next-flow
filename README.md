# NextFlow AI — Landing Page

AIタスク管理SaaSのランディングページ。クリーン・ミニマルなデザインと、ダークモード・スクロールアニメーション・料金トグルなどのインタラクションを実装したポートフォリオ作品。

## デモ

> `index.html` をブラウザで開くか、ローカルサーバで起動してください。
...
- 参考: [参考デザインサイト](https://sankoudesign.com/)
